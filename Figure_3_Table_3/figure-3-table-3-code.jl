...
eeb_u_hm = f_inv(E_u_log_y_b, gamma)
eeb_l_hm =f_inv(E_l_log_y_b, gamma)

sol_hm_1 = solve_for_z(eeb_u_hm, eea_l_hm, eeb_l_hm, eea_u_hm, gamma)
...
eea_u_hm_2 = f_inv(E_u_f_y_a_2, gamma)
eea_l_hm_2 =f_inv(E_l_f_y_a_2, gamma)

eeb_u_hm_2 = f_inv(E_u_f_y_b_2, gamma)
...
E_l_log_y_a_Lee = 1.997
E_u_log_y_a_Lee = 1.997

E_l_log_y_b_Lee = 1.978
E_u_log_y_b_Lee = 2.090

eea_u_Lee = f_inv(E_u_log_y_a_Lee, gamma_1)
eea_l_Lee =f_inv(E_l_log_y_a_Lee, gamma_1)

eeb_u_Lee = f_inv(E_u_log_y_b_Lee, gamma_1)
eeb_l_Lee =f_inv(E_l_log_y_b_Lee, gamma_1)

sol_l = solve_for_z(eeb_u_Lee, eea_l_Lee, eeb_l_Lee, eea_u_Lee, gamma)
...
sol_l_2 = solve_for_z(eeb_u_Lee_2, eea_l_Lee_2, eeb_l_Lee_2, eea_u_Lee_2, gamma)



# Lee bounds on levels (From Michelle's calculations)
# gamma = 0
...
# Chen and Flores bounds (From Chen and Flores 2014, p. 533)
gamma_1 = 1
E_l_log_y_a_CF = 1.972
E_u_log_y_a_CF = 1.972

E_l_log_y_b_CF = 2.027
E_u_log_y_b_CF = 2.102

eea_u_CF = f_inv(E_u_log_y_a_CF, gamma_1)
eea_l_CF =f_inv(E_l_log_y_a_CF, gamma_1)

eeb_u_CF = f_inv(E_u_log_y_b_CF, gamma_1)
eeb_l_CF =f_inv(E_l_log_y_b_CF, gamma_1)

sol_CF = solve_for_z(eeb_u_CF, eea_l_CF, eeb_l_CF, eea_u_CF, gamma_1)

# Chen and Flores bounds (From Michelle's calculations)
# gamma = 2
...
# Chen and Flores bounds on levels (From Michelle's calculations)
# gamma = 0
